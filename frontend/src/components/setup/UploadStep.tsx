import { Upload, FileText } from "lucide-react"; // Make sure to use lucide icons!
  ...
  return (
    <div className="max-w-3xl mx-auto px-4">
      ...
      <p className="mt-2 text-gray-500 text-sm leading-relaxed">
        We'll extract your course's grading structure automatically. Don't
        worry, you can review and adjust everything before moving forward.
      </p>
