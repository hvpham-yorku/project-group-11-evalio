...
## 2. Rationale Behind Plan Changes & Major Design Decisions
(To be updated by the team)
...
## 5. Development Tasks per User Story
...
## 6. Time Allocation Summary

| User Story | Planned Time | Actual Time |
|------------|--------------|-------------|
| ITR1-1 |  |  |
| ITR1-2 |  |  |
| ITR1-3 |  |  |
